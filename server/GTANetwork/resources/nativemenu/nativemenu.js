...
var Menu = (function () {
    ...
    Object.defineProperty(Menu.prototype, "Ready", {
        get: function () {
            return isReady;
        },
    ...
    Object.defineProperty(Menu.prototype, "Blur", {
        get: function () {
            return this._blur;
        },
    ...
    Object.defineProperty(Menu.prototype, "DisableOverlays", {
        set: function (value) {
    ...
    Menu.prototype.nextPage = function () {
    ...
    Menu.prototype.prevPage = function () {
        if (currentPage - 1 < 0) {
     ...
     * @param yGridHeight
     */
    Menu.prototype.createPanel = function (page, xStart, yStart, xGridWidth, yGridHeight) {
...
var PlayerTextNotification = (function () {
    function PlayerTextNotification(text) {
    ...
    PlayerTextNotification.prototype.draw = function () {
        if (!this._drawing) {
            return;
        }
    ...
    PlayerTextNotification.prototype.setColor = function (r, g, b) {
        this._r = r;
        this._g = g;
        this._b = b;
    };
    PlayerTextNotification.prototype.cleanUpNotification = function () {
        this._drawing = false;
        textnotification = null;
    };
    PlayerTextNotification.prototype.returnType = function () {
...
var Notification = (function () {
    function Notification(text, displayTime) {
    ...
    Notification.prototype.cleanUpNotification = function () {
        notification = null;
    };
    Notification.prototype.setText = function (value) {
        this._text = value;
    };
    Notification.prototype.setColor = function (r, g, b) {
        this._r = r;
        this._g = g;
        this._b = b;
    };
    Notification.prototype.setTextScale = function (value) {
        this._textScale = value;
    };
    Notification.prototype.isHovered = function () {
        return;
    };
    Notification.prototype.isClicked = function () {
        return;
    };
    Notification.prototype.returnType = function () {
        return "Notification";
    };
    return Notification;
}());
